    ...
    <div className="min-h-screen bg-[#fbf9f9] font-sans text-slate-900">
      ...
      <div className="lg:pl-60">
        ...
        <main className="mx-auto max-w-4xl px-4 py-8 lg:px-8 lg:py-10">
          <div className="mb-8">
            <h2 className="serif-heading text-3xl text-[#2d2424]">Resumen del Mes</h2>
            <p className="mt-1 text-[#846262]">Visualiza el rendimiento de tu negocio</p>
          </div>
          ...
          <div className="rounded-2xl border border-[#e9cece]/60 bg-white p-6 shadow-sm">
            <div className="mb-6 flex items-center justify-between">
              <div>
                <h3 className="serif-heading text-xl text-[#2d2424]">Ingresos Diarios</h3>
                <p className="text-sm text-[#846262]">Tendencia de ingresos durante el mes</p>
              </div>
              <div className="flex items-center gap-2">
