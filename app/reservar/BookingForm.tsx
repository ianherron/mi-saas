  ...
  return (
    <div className="min-h-screen bg-[#fbf9f9] overflow-hidden">
      <main className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleSubmit(new FormData(e.currentTarget)); }} className="flex flex-col gap-16 lg:flex-row lg:gap-12">
              ...
              <div className="divide-y divide-slate-100">
                ...
                {date && time && (
                  <div className="py-3">
                    ...
                    <p className="mt-1 text-sm capitalize text-[#2d2424]">
